...
from githubhacker import account_manager, storage
...
def config_export(
    ...
    try:
        from githubhacker import storage
        ...
        # Export format: {name: {token: ..., username: ...}}
...
def star(
    ...
    """Star a repository."""
    try:
        from githubhacker.account_manager import parse_repo
...
def fork(
    ...
    try:
        ...
        console.print(table)
        console.print(f"\n[bold]Summary:[/bold] {success_count}/{len(results)} accounts succeeded\n")
...
def main():
    try:
        ...
        console.print("  python main.py login <name> <token>")
        console.print("  python main.py logout <name>")
        console.print("  python main.py config list")
        console.print("  python main.py config import <file>")
        console.print("  python main.py config export <file>")
        console.print("  python main.py config whoami")
        console.print("  python main.py config validate")
        console.print("  python main.py star <repo>")
        console.print("  python main.py star <repo> -a <account>")
        console.print("  python main.py unstar <repo>")
        console.print("  python main.py watch <repo>")
        console.print("  python main.py unwatch <repo>")
        console.print("  python main.py status <repo>")
        console.print("  python main.py fork <repo>")
        console.print("  python main.py info <repo>")
